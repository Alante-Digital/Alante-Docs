...
3. Elige el tipo con las tarjetas visuales:
   - **Entrada** — incrementa stock
   - **Salida** — reduce stock disponible
   - **Ajuste** — corrige diferencias de inventario
4. Completa las secciones numeradas del formulario (almacén, productos, detalles):
   - **Almacén**: donde ocurre el movimiento
   - **Fecha**: fecha y hora (por defecto la actual)
   - **Centro de costos** (opcional)
   - **Notas** (opcional)
5. Agrega productos con cantidad y, en entradas o ajustes positivos, el costo unitario
6. Revisa el total calculado
7. Guarda el movimiento
...
- Con los permisos adecuados, un movimiento puede editarse o eliminarse después de guardado
...
### Flujo guiado (Transferir stock)

Desde **Inventario → Transferir stock** el proceso va por pasos:
...
- Con permisos adecuados pueden editarse o eliminarse; el sistema recalcula kardex, costos y asientos
...
- Flujo guiado para entradas, salidas y ajustes
- Exportación e impresión inmediata
