...
## Reporte para descuento en nómina

En **RRHH → Reportes → Préstamos a empleados** puedes consultar los saldos pendientes y, con el permiso adecuado, **postear el descuento a la nómina** para que se refleje en el cálculo laboral.

> No confundir con los préstamos de **Cajas y Bancos** (préstamos de la empresa con bancos u otras entidades).
